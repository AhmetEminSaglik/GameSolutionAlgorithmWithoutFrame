...
public abstract class AfterStep implements IStep {
    ...
    public AfterStep(UpdateValuesInGameModel updateValuesInGameModel) {
        this.gameModel = updateValuesInGameModel.getGameModel();
    ...
    /* public AfterStep(GameModel gameModel, UpdateValuesInGameModel updateValuesInGameModel) {
